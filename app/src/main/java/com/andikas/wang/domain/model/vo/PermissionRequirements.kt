...
enum class Permission(
    ...
    POST_NOTIFICATIONS(
        ...
        override fun getLocalizedTitle(strings: AppStrings) = strings.permNotificationsTitle
        override fun getLocalizedDescription(strings: AppStrings) = strings.permNotificationsDesc
    },
    BATTERY_OPTIMIZATION(
        ...
        override fun getLocalizedTitle(strings: AppStrings) = strings.permBatteryTitle
        override fun getLocalizedDescription(strings: AppStrings) = strings.permBatteryDesc
    },
    NOTIFICATION_LISTENER(
        ...
        override fun getLocalizedTitle(strings: AppStrings) = strings.permNotificationListenerTitle
        override fun getLocalizedDescription(strings: AppStrings) = strings.permNotificationListenerDesc
    },
    SYSTEM_ALERT_WINDOW(
        "Display Over Apps",
        ...
        override fun getLocalizedTitle(strings: AppStrings) = strings.permSystemAlertTitle
        override fun getLocalizedDescription(strings: AppStrings) = strings.permSystemAlertDesc
    },
    USE_BIOMETRIC(
        "Biometric",
        ...
        override fun getLocalizedTitle(strings: AppStrings) = strings.permBiometricTitle
        override fun getLocalizedDescription(strings: AppStrings) = strings.permBiometricDesc
    },
    INTERNET(
        "Internet",
        ...
        override fun getLocalizedTitle(strings: AppStrings) = strings.permInternetTitle
        override fun getLocalizedDescription(strings: AppStrings) = strings.permInternetDesc
    },
    USER_API_KEY(
        "API Key",
        ...
        override fun getLocalizedTitle(strings: AppStrings) = strings.permApiKeyTitle
        override fun getLocalizedDescription(strings: AppStrings) = strings.permApiKeyDesc
    },
    MIUI_AUTOSTART(
        "Autostart",
        ...
        override fun getLocalizedTitle(strings: AppStrings) = strings.permMiuiAutostartTitle
        override fun getLocalizedDescription(strings: AppStrings) = strings.permMiuiAutostartDesc
    },
    MIUI_BATTERY_NO_RESTRICT(
        ...
        override fun getLocalizedTitle(strings: AppStrings) = strings.permMiuiBatteryTitle
        override fun getLocalizedDescription(strings: AppStrings) = strings.permMiuiBatteryDesc
    },
    MIUI_BACKGROUND_POPUP(
        ...
        override fun getLocalizedTitle(strings: AppStrings) = strings.permMiuiPopupTitle
        override fun getLocalizedDescription(strings: AppStrings) = strings.permMiuiPopupDesc
    };

    open fun getLocalizedTitle(strings: AppStrings): String = title
    open fun getLocalizedDescription(strings: AppStrings): String = description
}
